...
# Список в котором храним id и его расстояние игрока до стула
...
for chair in chairs_num:
    if chair != []:
        # Ищем игрока, который добежит первым, но при этом его расстояние будет самым большим среди всех
